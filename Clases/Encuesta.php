...
class Encuesta extends Conexion
{
    ...
    public function insertarRespuesta($usuario_id)
    {
        if ($_SERVER['REQUEST_METHOD'] == 'POST') {
            ...
            try {
                $stmt->execute([$usuario_id, $pregunta_1, $pregunta_2, $pregunta_3, $pregunta_4, $pregunta_5, $pregunta_6, $pregunta_7, $pregunta_8, $pregunta_9, $pregunta_10, $pregunta_11, $pregunta_12, $pregunta_13, $pregunta_14, $pregunta_15]);
                return true;
